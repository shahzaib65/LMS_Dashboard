...
<div className=' w-full h-20 bg-white flex justify-start'>
...
{
    isSidebarOpen && (
        <div class="fixed top-0 left-0 z-40 w-64 h-screen p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800" tabindex="-1">
